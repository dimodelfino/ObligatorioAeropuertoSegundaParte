 ...
 * @author dmoreno
 */
public class MenuCompania extends javax.swing.JDialog {

    /**
     * Creates new form IngresarFrecuencia
     */
    public MenuCompania(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ingresar Frecuencia");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuCompania.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MenuCompania dialog = new MenuCompania(new javax.swing.JFrame(), true);
